export default [
  {
    ...
    children: [
      ...
      {
        path: 'reports/beneficiaries-by-commune',
        name: 'admin-reports-beneficiaries-by-commune',
        component: () => import('@/views/admin/reports/BeneficiariesByCommuneView.vue'),
        meta: { title: 'Bénéficiaires par commune' },
      },
      {
        path: 'reports/beneficiaries-by-school',
        name: 'admin-reports-beneficiaries-by-school',
        component: () => import('@/views/admin/reports/BeneficiariesBySchoolView.vue'),
        meta: { title: 'Bénéficiaires par école' },
      },
